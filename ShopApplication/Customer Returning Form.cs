...
{
    public partial class Customer_Returning_Form : Form
    {
        private DataSet ds;
        private double totalMaterial;
        public Customer_Returning_Form()
        {
            InitializeComponent();
        }
        ...
        private void RefForm()
        {
            ...
            object o = Ezzat.ExecutedScalar("EXReturning_selectID");
        ...
        private void Customer_Returning_Form_Load(object sender, EventArgs e)
        {
            RefForm();
        }
        ...
        private void Calcolate()
        {
            ...
            txt_Total.Text = String.Format("{0:0.00}", (double.Parse(txt_OldMoney.Text))- double.Parse(txt_AfterDiscount.Text));
        }
        ...
        {
            Ezzat.ExecutedNoneQuery("Customer_insertReturningBill"
